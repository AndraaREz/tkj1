-- WAYPOINT GUI - FIXED VERSION
print("🔄 Loading Waypoint GUI...")
...
local success, error = pcall(function()
    ...
    WaypointList.Size = UDim2.new(1, 0, 1, -35)
    WaypointList.Position = UDim2.new(0, 0, 0, 35)
    ...
    local function createWaypointItem(name, position)
        ...
        GoBtn.Size = UDim2.new(0.22, 0, 0, 20)
        GoBtn.Position = UDim2.new(0.48, 0, 0, 2)
        ...
        DelBtn.Size = UDim2.new(0.22, 0, 0, 20)
        DelBtn.Position = UDim2.new(0.73, 0, 0, 2)
    ...
    MinBtn.MouseButton1Click:Connect(function()
        ...
        if isMinimized then
            MainFrame:TweenSize(UDim2.new(0, 280, 0, 25), "Out", "Quad", 0.3, true)
            MinBtn.Text = "+"
        else
