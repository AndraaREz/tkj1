...
function WaypointSystem.new()
    ...
    self.loopWaypointsEnabled = false -- Menambahkan status untuk loop waypoints
...
function WaypointSystem:Initialize()
    ...
    self.waypointOrder = {} -- Inisialisasi daftar urutan waypoint
    for waypointName, _ in pairs(self.waypoints) do
        table.insert(self.waypointOrder, waypointName) -- Tambahkan semua waypoint ke daftar
    end
...
function WaypointSystem:CreateGUI()
    ...
    main.Name = "Main"
    main.Size = UDim2.new(0, 250, 0, 400) -- Ukuran lebih kecil
    main.Position = UDim2.new(1, -270, 0.5, -200) -- Sesuaikan posisi
...
function WaypointSystem:CreateWaypointsTab(parent)
    ...
    self:CreateLoopSection(tab) -- Tambahkan bagian untuk Loop Waypoint
end
...
function WaypointSystem:CreateLoopSection(parent)
    ...
    section.Position = UDim2.new(0, 10, 1, -50) -- Tempatkan di atas footer
    ...
    section.Size = UDim2.new(1, -20, 0, 35) -- menyesuaikan ukuran
